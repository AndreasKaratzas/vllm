...
def _get_registration_region(
    ...
    *,
    ...
    Mamba/Hybrid SSM caches are different: conv and SSM states are strided
    views into one raw allocation. Registering the backing storage keeps the
    RDMA registration aligned with the actual allocation while transfer
    descriptors can still use the logical view data pointer.
    """
    ...
    def _compute_desc_ids(
        ...
        if num_ssm_regions == 0:
            ...
            if (
                ...
                if not all(region_ids == all_region_ids for region_ids in group_region_ids):
        ...
        for layer_name, cache_or_caches in xfer_buffers.items():
            ...
            for cache in cache_list:
                ...
                reg_base_addr, reg_size_bytes = _get_registration_region(
                    ...
                    use_storage_region=isinstance(layer_spec, MambaSpec),
                )
                caches_data.append(
